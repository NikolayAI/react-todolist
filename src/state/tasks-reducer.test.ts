...
beforeEach(() => {
    startState = {
        ...
        "todolistId2": [
            ...
            { id: "2", title: "milk", status: TaskStatuses.Completed, todoListId:"todolistId2", startDate:'', priority: TaskPriorities.Low, order: 0, description:'', deadline: '', addedDate: '', },
...
test('title of specified task should be changed', () => {
    ...
    const action = updateTaskAC("todolistId1", '1', {title: 'HTML'});
